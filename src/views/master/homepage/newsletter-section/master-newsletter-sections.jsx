...
import EditSectionForm from './newsletter-edit-section-form';
...
import { PARAMS_NEWSLETTER_SECTIONS } from 'constants/components/homepage';
import { Role } from 'constants/role';
import { getAllSections } from 'redux/master/actions/master-newsletter-section-actions';
...
export const MasterNewsletterSections = () => {
  ...
  const content = useMemo(() => {
    ...
    return slidesToShow.map(item => (
      <MasterSlideCard
        ...
        fieldParams={PARAMS_NEWSLETTER_SECTIONS}
