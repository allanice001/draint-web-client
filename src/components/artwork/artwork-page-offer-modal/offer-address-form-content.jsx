...
import ItemsImage from 'components/cart/checkout-shipping/items-image';
import RatesSelector from 'components/cart/checkout-shipping/rates-selector';
...
import styles from 'components/cart/checkout-shipping/checkout-shipping-info.module.scss';

const Settings = require('settings.json');

function OfferAddressForm({
  handleRateChange,
  confirmShipment,
  cancelShipment,
...
function mapStateToProps(state) {
  return {
    calculating: state.cart.cartData.calculating,
    account: state.user.account,
    address: state.user.account.location.address,
  };
}

export default connect(mapStateToProps)(OfferAddressForm);
