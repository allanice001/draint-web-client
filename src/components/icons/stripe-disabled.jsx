...
export default function StripeDisabled(propertioes) {
  const { param: parameter } = propertioes;
  ...
  return (
    ...
    >
      <defs>
        <linearGradient
          id="prefix__a_disabled"
          x1="100%"
          x2="0%"
          y1="58.356%"
          y2="0%"
        >
          <stop offset="0%" stopColor="#70c2d4" />
          <stop offset="50%" stopColor="#8faecb" />
          <stop offset="100%" stopColor="#71aece" />
        </linearGradient>
        <filter
          filterUnits="objectBoundingBox"
          height="200%"
          id="prefix__b_disabled"
          width="200%"
          x="-50%"
          y="-50%"
        >
      ...
      <path d="M0 0h256v256H0z" fill="url(#prefix__a_disabled)" />
      <path
