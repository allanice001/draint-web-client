...
export default function AmexIconBw(properties) {
  const { param: parameter } = properties;

  return (
    <svg height={parameter} viewBox="0 0 156 128" width={parameter}>
      <defs>
        <path
          d="M13.9 29.3c0-3.3 2.7-6 6-6h116c3.3 0 6 2.7 6 6v68c0 3.3-2.7 6-6 6h-116c-3.3 0-6-2.7-6-6v-68z"
          id="prefix__aAmexIconBw"
        />
      </defs>
      <clipPath id="prefix__bAmexIconBw">
        <use overflow="visible" xlinkHref="#prefix__aAmexIconBw" />
      </clipPath>
      <path
        clipPath="url(#prefix__bAmexIconBw)"
        d="M13.9 29.3c0-3.3 2.7-6 6-6h116c3.3 0 6 2.7 6 6v68c0 3.3-2.7 6-6 6h-116c-3.3 0-6-2.7-6-6v-68z"
        fill="#9e9e9e"
      />
      <g>
        <defs>
          <path
            ...
            id="prefix__cAmexIconBw"
          />
        </defs>
        <clipPath id="prefix__dAmexIconBw">
          <use overflow="visible" xlinkHref="#prefix__cAmexIconBw" />
        </clipPath>
        <path
          clipPath="url(#prefix__dAmexIconBw)"
      ...
      <g>
        <defs>
          <path
            ...
            id="prefix__eAmexIconBw"
          />
        </defs>
        <clipPath id="prefix__fAmexIconBw">
          <use overflow="visible" xlinkHref="#prefix__eAmexIconBw" />
        </clipPath>
        <path
          clipPath="url(#prefix__fAmexIconBw)"
          d="M10.4 36.3h129.2v30.5H10.4z"
          fill="white"
        />
        <path d="M86.3 44.2h3.6v14.7h-3.6z" fill="white" />
      </g>
    </svg>
  );
}
